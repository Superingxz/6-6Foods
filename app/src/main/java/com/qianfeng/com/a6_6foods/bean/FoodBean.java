...
public class FoodBean {
    ...
    public FoodBean(int count, String description, String disease, int fcount, String food, int id, String img, String keywords, String name, int rcount, String summary, String symptom) {
        this.count = count;
